...
const Pagination = ({ data, RenderComponent /* list of names*/, pageLimit, dataLimit }) => {
	...
	return (
		<>
				...
				{/* show the list, 10 names at a time */}

				{getPaginatedData().map((d, idx) => {
					console.log('data here-->', d)
					return <RenderComponent key={idx} index={idx} user={d} />
				})}
